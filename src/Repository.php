...
use BlackCat\Database\Packages\KeyWrappers\Repository\KeyWrapperRepository;
...
{
    private KeyWrapperRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new KeyWrapperRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KeyWrappers\Dto\KeyWrapperDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\KeyWrappers\Dto\KeyWrapperDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KeyWrappers\Dto\KeyWrapperDto|null
    {
