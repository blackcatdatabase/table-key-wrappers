...
use BlackCat\Database\Packages\KeyWrappers\Repository\KeyWrapperRepository as GeneratedRepository;
...
{
  private KeyWrapperRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof KeyWrapperRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected KeyWrapperRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KeyWrappers\Dto\KeyWrapperDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KeyWrappers\Dto\KeyWrapperDto|null { return $this->repo->getById($id, $asDto); }
