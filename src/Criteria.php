...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'wrapper_uuid', 'kms1_key_id', 'kms2_key_id', 'dek_wrap1', 'dek_wrap2', 'crypto_suite', 'wrap_version', 'status', 'created_at', 'rotated_at' ];
    }
    ...
    {
        $x = [ 'id', 'wrapper_uuid', 'kms1_key_id', 'kms2_key_id', 'wrap_version', 'status', 'created_at', 'rotated_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\KeyWrappers\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\KeyWrappers\Definitions::softDeleteColumn();
