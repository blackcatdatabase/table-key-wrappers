...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'key_wrappers'; }
    public static function contractView(): string { return 'vw_key_wrappers'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'wrapper_uuid', 'kms1_key_id', 'kms2_key_id', 'dek_wrap1', 'dek_wrap2', 'crypto_suite', 'wrap_version', 'status', 'created_at', 'rotated_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'wrapper_uuid' ], [ 'kms1_key_id', 'kms2_key_id', 'wrap_version' ], [ 'id' ] ]; }

    /** @return string[] JSON columns for casts/operations */
    public static function jsonColumns(): array { return [ 'crypto_suite' ]; }

    /** @return string[] List of numeric columns (generator heuristic; no runtime DB queries). */
    public static function intColumns(): array { return [ 'id', 'kms1_key_id', 'kms2_key_id', 'wrap_version' ]; }
